...
| FCC MET 매핑 | `/appdata/hadoop/code/eads/PFB3/D1c_fcc/met_fcc.txt` | `device`, `main_step`, `met_step`, `step_desc`, `sdwt` |
| FCC 중심치 이상 목록 | `/appdata/hadoop/code/eads/PFB3/D1c_fcc/fcc_step/fail_list_fcc.parquet` | `main_seq`, `met_seq`, `eqp_ch` |
| FCC 산포 이상 목록 | `/appdata/hadoop/code/eads/PFB3/D1c_fcc/fcc_step/fail_list_std_fcc.parquet` | `main_seq`, `met_seq`, `eqp_ch` |
...
| FCC all 배경 scatter | `/appdata/hadoop/code/eads/PFB3/D1c_fcc/fcc_step/fcc_{met_step}/{latestDate}/all_fcc_{met_step}.parquet` | `tkout_time`, `defect_value`, `wafer_id`, `lot_id`, `lot_wf`, `step_seq`, `eqp_ch`, `process_id`, `item_id`, `final_decision` |
| FCC fail 중심치 이상 scatter | `/appdata/hadoop/code/eads/PFB3/D1c_fcc/fcc_step/fcc_{met_step}/{latestDate}/fail_fcc_{met_step}.parquet` | `tkout_time`, `defect_value`, `wafer_id`, `lot_id`, `lot_wf`, `step_seq`, `eqp_ch`, `process_id`, `item_id`, `final_decision` |
| FCC fail_std 산포 이상 scatter | `/appdata/hadoop/code/eads/PFB3/D1c_fcc/fcc_step/fcc_{met_step}/{latestDate}/fail_std_fcc_{met_step}.parquet` | `tkout_time`, `defect_value`, `wafer_id`, `lot_id`, `lot_wf`, `step_seq`, `eqp_ch`, `process_id`, `item_id`, `final_decision`, `std_result` |
