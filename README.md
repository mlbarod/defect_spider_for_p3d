...
| FCC 중심치 이상 목록 | `/appdata/hadoop/code/eads/PFB3/D1c_fcc/fcc_step/fail_list.parquet` | `main_seq`, `met_seq`, `eqpid` 또는 `eqpch` |
...
| PM 이력 | `/appdata/abnormal_trend/pic/pm_code_info.parquet` | `asset` 또는 `eqp_ch`/`eqpch`, `inprg_dt`, `work_type` |
